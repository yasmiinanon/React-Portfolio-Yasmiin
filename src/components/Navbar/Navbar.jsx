...
function Navbar() {
  return (
    <nav className="navbar navbar-expand-lg bg-body-tertiary customNav back">
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li><a className="dropdown-item" href="#ComingSoon"><i className="bi bi-code-slash mx-4"></i>Coming Soon!</a></li>
              </ul>
            </li>
            ...
            <li className="nav-item">
              <a className="btn btn-primary btn-lg navCTA"
