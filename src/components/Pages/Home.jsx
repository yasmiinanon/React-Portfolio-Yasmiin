    ...
    <div className="p-5 bg-body-tertiary ldnBackground background-tint">
      <div className="container-fluid py-5 jumboCopy">
        ...
        <div className="d-flex col">
          <img className="img-fluid rounded mb-3" src="/React-Portfolio-Yasmiin/assets/avatar.png" href="./public/avatar.png" alt="image of a woman posing at the top of a mountain edge"></img>
